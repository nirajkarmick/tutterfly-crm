...
@Component({
  ...
  styleUrls: ['./quil-editor.component.css']
})
export class QuilEditorComponent implements OnInit {
...
onEditorChange(val){ 
 ...
 if(this.description_html==undefined){     
   ...
   //this.editor.insertText( this.editor.getLength() - 1, 'Hello')  
}

insertDynamicPlaceholder(val){
                ...
                // }
                // this.editor_selected.insertText(index, ' '+val , '', true);
