...
constructor(private http:HttpClient) {}
   public getAllAccounts(){
      ...
      let result  = this.http.get(environment.ip+'/rest_accounts').pipe(map((response: Response) => response));
      return result;
    }

   public moreAccounts(curr_page){  
     let result  = this.http.get(environment.ip+'/rest_accounts?page='+curr_page).pipe(map((response: Response) => response));
      return result;
    }
    ...
    public createClient(account:Account){
      let result = this.http.post(environment.ip+'/rest_accounts',account).pipe(map((response: Response) => response));
      return result;
    }
    public getClientDetails(clientId:number){
      let result = this.http.get(environment.ip+'/rest_accounts/'+clientId).pipe(map((response: Response) => response));
      return result;
    }
    ...
    public pinned_view(viewId:any){
      ...
      let result = this.http.post(environment.ip+'/rest_pin_views_account',data).pipe(map((response: Response) => response));
      return result;
    }
    public unpinned_view(viewId:any){
      let data={'account_view_id':viewId};
      let result = this.http.post(environment.ip+'/rest_unpin_views_account',data).pipe(map((response: Response) => response));
      return result;
    }
    ...
    public createView(name:string,visi:number){
      let result = this.http.post(environment.ip+'/rest_accounts_views',{"name":name,"public_view":visi}).pipe(map((response: Response) => response));
      return result;
    } 
    public updateView(viewId:number,column:number[]){
      let result = this.http.post(environment.ip+'/rest_accounts_columns',{"view_id":viewId,"column_id":column}).pipe(map((response: Response) => response));
      return result;
    }
    ...
    var cors=""; 
      ...
      let result = this.http.post(cors+environment.ip+'/rest_accounts_additional_columns',{"view_id":viewId,"column_id":column}).pipe(map((response: Response) => response));
      return result;
    }
    ...
    if (location.hostname.search("192.168")>=0  ||  location.hostname.search("localh")>=0){ 
      ...
      let result = this.http.get(cors+environment.ip+'/rest_accounts_views/'+viewId+page_s).pipe(map((response: Response) => response));
      return result;
    }
    ...
    public updateSingleColumn (updateV:any){
      ...
      let result = this.http.post(environment.ip+'/rest_accounts/single_column',updateV).pipe(map((response: Response) => response));
      return result;
    }
    public saveFilter(filterArr:any[]){
      let result = this.http.post(environment.ip+'/rest_accounts_filters',filterArr).pipe(map((response: Response) => response));
      return result;
    }
    ...
    public rest_accounts_list(){
      let result = this.http.get(environment.ip+'/rest_accounts_list').pipe(map((response: Response) => response));
      return result;
    }
    ...
    public updateClient(account:Account){
      let result = this.http.put(environment.ip+'/rest_accounts/'+account.id,account).pipe(map((response: Response) => response));
      return result;
    }
    public  rename(viewId :number,name:string){
      let result = this.http.patch(environment.ip+'/rest_accounts_views/'+viewId,{      "name":name  }  ).pipe(map((response: Response) => response));
      return result;
    }
    public viewVisibilityUpdate(viewId:any,type:number){
      let result = this.http.patch(environment.ip+'/rest_accounts_views/'+viewId,{ "public_view":type}).pipe(map((response: Response) => response));
      return result;
     }
     public delete(id:number){
      let result = this.http.delete(environment.ip+'/rest_accounts/'+id).pipe(map((response: Response) => response));
      return result;
     }
 ...
 public getStandardFileds(){  
   let result = this.http.get(environment.ip+'/rest_standard_fields_account').pipe(map((response: Response) => response));
   return result;
 }
